...
```java
public class MainActivity extends Activity {  // or AppCompactActivity
...
```java
Picasso.with(context).load("http://www.abc.com/first.jpg").into(imageView);
```

```java
Picasso.with(context)
        .load("http://www.abc.com/first.jpg")
        .into(imageView);
```
...
```java
loadPicture(context, "http://www.abc.com/first.jpg", mImageViewProfilePicture, clickListener, "Title");
```

```java
loadPicture(context,
        "http://www.abc.com/first.jpg",
...
```xml
<TextView
	android:id="@+id/txt_module_profile"
